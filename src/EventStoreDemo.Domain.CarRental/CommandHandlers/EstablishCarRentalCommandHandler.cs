...
{
    public class EstablishCarRentalCommandHandler : CommandHandler<CarRental>
    {
        public EstablishCarRentalCommandHandler(EstablishCarRental command) : base(command, new DomainEventHandlerResolver())
        {
            _command = command;
        }
